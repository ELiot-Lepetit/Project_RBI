...
(ii) Select the Social-demographic indicators for year 2022-23; Birth rate, Death rate, Population, Literacy rate, Infant Mortality rate etc. (iii) Download the respective files as excel from both the links.
...
1.  Net State Domestic Product (NSDP) - State-wise (At Constant Prices)
...
The socio-economic data is obtained from the Handbook of Statistics on Indian States for year 2022-2023, an annual publication by the Reserve Bank of India.
...
The key indicators included are: • State-wise Literacy Rate: Proportion of the population aged seven and above who can read and write with understanding.
...
While the NSDP data offers insights into the scale and composition of economic activity, the socio-economic indicators reveal the underlying human capital and health factors influencing economic growth.
...
-   Research question outlines and provides an initial visualization of the target variable.
