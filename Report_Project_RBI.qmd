...
In Block 1 hypothesis, we use 2019 data and analyse significant relationships between key indicators and economic performance. States with higher NSDP demonstrate robust fiscal capacity, enabling greater investment in health expenditure. This, in turn, is linked to improved outcomes such as lower infant mortality and death rates. However, the analysis highlights clustering among states with low NSDP and health spending, underscoring the need for targeted interventions in underperforming regions.
...
1.  Targeted Investment in Health: Continuing to invest in programs like Ayushman Bharat and enhanced funding for primary healthcare infrastructure could prioritize regions with high mortality rates and low fiscal capacity.
