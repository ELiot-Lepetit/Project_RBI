...
In this report, We try to understand the comprehensive interplay between socio-demographic indicators and Net State Domestic Product (NSDP) across Indian states, uncovering critical insights into the regional disparities in economic and social development in 2011 and 2019.

In Block 1 hypothesis, we use 2019 data and analyse significant relationships between key indicators and economic performance. States with higher NSDP demonstrate robust fiscal capacity, enabling greater investment in health expenditure. This, in turn, is linked to improved outcomes such as lower infant mortality and death rates. However, its impact on mortality outcomes remains weak and statistically insignificant, underscoring the need for a broader, multivariate approach. We analyse on a state level, and observe higher NSDP is associated with greater health investments, as seen in states like Maharashtra. On a per-capita level, we observe that population effect becomes evident. Smaller states like Nagaland and Meghalaya demonstrate efficient resource utilization, achieving higher per-capita health expenditure despite limited fiscal resources. Conversely, larger states like Uttar Pradesh face challenges in translating economic output into substantial per-capita health investments, reflecting the importance of policy prioritization and efficient resource allocation.

In Block 2 hypothesis, we use 2011 data and observe a positive correlation between NSDP and literacy rates, suggesting that states with stronger economies tend to achieve higher educational outcomes. However, the relationship lacks statistical significance, indicating that factors beyond economic output—such as policy focus, infrastructure, and cultural dynamics—play a substantial role. Furthermore, literacy rates were hypothesized to influence demographic outcomes. The analysis supports a strong negative correlation between literacy rates and birth rates, emphasizing the transformative impact of education on family planning and population control. Conversely, the relationship between literacy rates and sex ratios reveals unexpected results, with a weak and negative association that underscores the enduring influence of cultural and historical factors in shaping gender dynamics in India. We also refer some research to back our reasoning for the same. 
...
1.  Targeted Investment in Health: Continuing to invest in programs like Ayushman Bharat and enhanced funding for primary healthcare infrastructure could prioritize regions with high mortality rates and low fiscal capacity. Addressing regional disparities and population-driven challenges is also essential in achieving equitable health outcomes

2.  Strengthening Education Systems:  Policy programs like Samagra Shiksha Abhiyan can be expanded to address regional disparities in literacy rates and investment in quality education, including teacher training, infrastructure development, and technology integration, can help uplift regions with lower literacy rates.

3. Promoting Gender Equity: Programs addressing cultural norms—like Beti Bachao Beti Padhao will help render a positive impact for the weak correlations between literacy rates and sex ratios in Block 2 Hypothesis.

4. Monitoring and Data Collection: Prioritizing consistent data collection across all socio-demographic and economic indicators would enable more robust analysis and evidence-based decision-making. Collaborations with organizations like the Reserve Bank of India (RBI) and National Sample Survey Office (NSSO) for datasets ensure more reliable insights.

Thus, the report underscores the intricate relationship between socio-demographic indicators and economic performance across Indian states in year 2011 and 2019, revealing both progress and disparities. Addressing these disparities is vital for fostering inclusive development, as states with weaker socio-economic outcomes often require targeted interventions to unlock their potential. The findings emphasize the need of a multi-stakeholder collaboration, spanning across policymakers, educators, healthcare providers, and regional governments which is essential for translating these insights into effective policy action. By prioritizing investments in health, education, and gender equity, India can pave the way for sustainable growth and equitable development.
